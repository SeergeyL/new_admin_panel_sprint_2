    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'Movie'), ('tv_show', 'TV Show')], max_length=255, verbose_name='film type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Актёр кинопроизведения',
                'verbose_name_plural': 'Актёры кинопроизведения',
